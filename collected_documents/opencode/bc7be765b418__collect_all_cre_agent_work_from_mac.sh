...
# CRE Foundry Mac Consolidator
# - Discovers actual Codex, Kimi, OpenCode, Relay, Antigravity, research,
#   checkpoint, prompt, and repository work across common Mac folders.
# - Does not modify source repositories.
# - Does not push to GitHub.
# - Creates:
#     PRIVATE_ARCHIVE/  complete local-only preservation material
#     PUBLIC_REPO/      sanitized, agent-readable working repository
#     REPORTS/          discovery, duplicates, conflicts, and safety findings
...
cat > "$OUT_BASE/collect_cre_work.py" <<'PY'
...
echo "CRE Foundry Mac Consolidator"
echo "Output: $OUT_BASE"
echo
echo "This reads source files and Git metadata, creates local copies, and does not push."
echo

"$PYTHON_BIN" "$OUT_BASE/collect_cre_work.py"

echo
echo "Open the organized folder:"
echo "  open \"$OUT_BASE\""
