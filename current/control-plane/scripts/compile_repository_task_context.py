...
TASK_PATHS = {
    ...
    "SECURITY-001": [
        ROOT / "tasks/SECURITY-001.json",
        ROOT / "artifacts/task-results/ARCHITECTURE-001.json",
        ROOT / "artifacts/task-results/RESEARCH-001.json",
        ROOT / "artifacts/research/claim_evidence_graph.json",
        ROOT / "artifacts/research/source_feasibility_registry.json",
        ROOT / "contracts/product_workflow.schema.json",
        ROOT / "scripts/validate_security_privacy.py",
    ],
}
